...
function SQLite3_BindText(hStmt: TSqliteStmt; ParamNum: integer;
  ptrData: pointer; numBytes: integer; ptrDestructor: pointer): integer;
cdecl; external SQLiteDLL name 'sqlite3_bind_text';

function SQLite3_BindInt(hStmt: TSqliteStmt; ParamNum: integer;
  Data: Integer): integer;
cdecl; external SQLiteDLL name 'sqlite3_bind_int';

function SQLite3_BindInt64(hStmt: TSqliteStmt; ParamNum: integer;
  Data: Int64): integer;
cdecl; external SQLiteDLL name 'sqlite3_bind_int64';

function SQLite3_BindFloat(hStmt: TSqliteStmt; ParamNum: integer;
  Data: Double): integer;
cdecl; external SQLiteDLL name 'sqlite3_bind_double';

function SQLite3_BindNull(hStmt: TSqliteStmt; ParamNum: integer): integer;
